      ...
      <div className="student__info-container">
        <div className="student__description">
          ...
          <p className="student__paragraph">
            ...
            вычилительной техники&raquo;. Мне нравится инструментальная музыка
            и&nbsp;добрые люди. Занимаюсь кроссом на&nbsp;велосипеде, зимой
            &mdash;на лыжах. Есть собака и&nbsp;кошка. В&nbsp;2021 году поступил
            на&nbsp;курс &laquo;Веб-разработчик&raquo; Я.Практикума
